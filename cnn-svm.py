...
if __name__ == "__main__":
    ...
    get_feature = theano.function([origin_model.layers[0].input],origin_model.layers[2].output,allow_input_downcast=False)
    ...
    scaler = MinMaxScaler()
    feature = scaler.fit_transform(feature_vector)
    svm(feature[0:train_number],label[0:train_number],feature[train_number:],label[train_number:])
